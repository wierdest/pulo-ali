...
import org.puloali.engine.scene.lights.SpotLight;
...
public class SceneRender {
    ...
    public SceneRender() {
        ...
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("puloali/src/main/resources/shaders/scene.vert", GL_VERTEX_SHADER));
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("puloali/src/main/resources/shaders/scene.frag", GL_FRAGMENT_SHADER));
